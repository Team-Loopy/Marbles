...
<h3>자산 이동</h3>
    <pre>   자산으로 표현되는 구슬은 다른 소유주에게 이동이 가능합니다</pre>
      <ul>
      ...
      <br>
      <h3>자산 추가<h3>
      <pre>  구슬컬러와 사이즈를 선택하여 추가하면 소유자의 지갑에 구슬이 추가됩니다.</pre>
      <ul>
        <li>기존 구슬 자산의 색상은 너무 단조로워 보여 웹에 풀려있는 css소스들을 활용해 구슬자산들을 그라데이션 색상으로 효과를 주었습니다.</li>
      </ul>
